...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    // how do we keep track of 81 diff text field?
    ...
    public void showDialog(String messages) {
        Alert dialog = new Alert(Alert.AlertType.CONFIRMATION, messages, ButtonType.OK);
        dialog.showAndWait();
    ...
    public void showError(String messages) {
        Alert dialog = new Alert(Alert.AlertType.ERROR, messages, ButtonType.OK);
        dialog.showAndWait();
